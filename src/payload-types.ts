...
export interface User {
  id: string;
  username: string;
  roles?: ('super-admin' | 'user' | 'admin')[] | null;
  tenants?:
    | {
...
export interface Tenant {
  ...
  name: string;
  /**
   * This is the subdomain of your store, it will be used to access your store. For example if you enter 'my-store' then your store will be accessible at my-store.funroad.com
   */
  slug: string;
  image?: (string | null) | Media;
  stripeAccountId: string;
  /**
   * This is true if the tenant has submitted their stripe details, this is used to determine if the tenant can receive payments or not.
   */
...
export interface Order {
  ...
  /**
   * Stripe account associated with the others
   */
